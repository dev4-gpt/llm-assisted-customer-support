...
- **LLM provider**: the API calls require a working LLM backend (default is Ollama). If you only want the offline/mock parts, you can run sections 2–4 without starting the server.
